...
function webfinger_profile_file_get_html() {
...
function webfinger_profile_str_get_html($str, $lowercase=true) {
    $dom = new simple_html_dom;
...
// dump html dom tree
function webfinger_profile_dump_html_tree($node, $show_attr=true, $deep=0) {
...
function webfinger_profile_file_get_dom() {
    $dom = new simple_html_dom;
    $args = func_get_args();
    $dom->load(call_user_func_array('file_get_contents', $args), true);
    return $dom;
...
function webfinger_profile_str_get_dom($str, $lowercase=true) {
    $dom = new simple_html_dom;
    $dom->load($str, $lowercase);
    return $dom;
}
